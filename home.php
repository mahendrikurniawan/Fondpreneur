...
<body>
    ...
    <section class="home" id="home">
        <div class="home-text">
            ...
            <p>FondPreneur adalah website yang berisikan seputar informasi tentang wirausaha. FoundPreneur ini juga
                bisa dijadikan sebagai wadah dan media pembelajaran bagi para mahasiswa yang tertarik seputar
                wirausaha.</p>
        </div>
        <div class="home-img">
            <img src="img/Pengusaha.png" alt="">
        </div>
    </section>
    <!--About-->
        ...
        <div class="products-container">
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a
                        href="https://www.tokopedia.com/kapulogo/buku-adam-grant-originals-tabrak-aturan-jadilah-pemenang?extParam=ivf%3Dfalse%26src%3Dsearch">Lihat
                        detail</a>
                </div>
            </div>
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a
                        href="https://shopee.co.id/Buku-Platform-Revolution--How-Networked-Market-i.326900811.11137982376">Lihat
                        detail</a>
                </div>
            </div>
            <div class="box">
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a
                        href="https://www.tokopedia.com/bookworldindo/buku-import-the-4-hour-work-week-by-tim-ferriss-original-paperback-hardcover?extParam=ivf%3Dfalse&src=topads">Lihat
                        detail</a>
                </div>
            </div>
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a
                        href="https://www.tokopedia.com/periplus/the-lean-startup-how-today-s-entrepreneurs-use-conti-9781524762407?extParam=ivf%3Dfalse%26src%3Dsearch">Lihat
                        detail</a>
                </div>
            </div>
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a
                        href="https://www.tokopedia.com/rekomendasi/2234390892?srsltid=AR5OiO31oXFC8EGF8CgayKgeh_TJU9dDD5uLx5xLZoKTMxxuavBzuI4vZww">Lihat
                        detail</a>
                </div>
            </div>
        </div>
    ...
    <section class="service" id="service">
        ...
        <div class="content-box">
            <div class="card">
                ...
                <h4>Logo</h4>
                <p>Melayani Pembuatan Logo</p>
            </div>

            <div class="card">
                <i class='bx bxl-unsplash bx-md'></i>
                <h4>Poster</h4>
                <p>Melayani Pembuatan Poster</p>
            </div>

            <div class="card">
                <i class='bx bx-id-card bx-md'></i>
                <h4>id card</h4>
                <p>Melayani Pembuatan id-card</p>
            </div>

            <div class="card">
                <i class='bx bxl-adobe bx-md'></i>
                <h4>Banner</h4>
                <p>Melayani Pembuatan Banner</p>
            </div>

            <div class="card">
                <i class='bx bxl-instagram-alt bx-md'></i>
                <h4>Feed IG</h4>
                <p>Melayani Pembuatan Feed IG.</p>
            </div>

            <div class="card">
                <i class='bx bxs-book-content bx-md'></i>
                <h4>Katalog</h4>
                <p>Melayani Pembuatan katalog.</p>
            </div>
    ...
    <section>
    <a href="crud/formMahasiswa.php" class="btn btn-sm btn-info mb-3">Tambah</a>
    ...
    <section>
    <a href="import/index.php" class="btn btn-sm btn-info mb-3">Eksport</a>
    </section>
    ...
    <section class="webinarinfo" id="webinarinfo">
        ...
        <div class="imgweb">
            <a href="https://drive.google.com/file/d/1rZTFvnuWZD_9BlaxCiHJcnvq0fvq1IMB/view" target="itembox"
                data-item="mobile"><img src="img/Web1.png" width="45px">
            </a>
            <a href="https://drive.google.com/file/d/1xT-NmH8r2X5rbV9RxL2pURqMKXiZOZkA/view" target="itembox"
                data-item="camera"><img src="img/web2.png">
            </a>
            <a href="https://drive.google.com/file/d/1F4mRTDaOaLn9ivsP59QMA5QfvV2S3qu_/view" target="itembox"
                data-item="watch"><img src="img/web3.png">
            </a>
            <a href="https://drive.google.com/file/d/16LRct9qEq7inixjNjXHCf9Qgvi8f-Id2/view" target="itembox"
                data-item="watch"><img src="img/web4.png">
            </a>
            <a href="https://drive.google.com/file/d/1lwaWMeYIeoR_YxzRnxQVF8DaIqCRn4m5/view" target="itembox"
                data-item="watch"><img src="img/web5.png">
            </a>
            <a href="https://drive.google.com/file/d/1MSxcH6p1PCnUE3GZDf9HHGL32T8SrOIV/view" target="itembox"
                data-item="watch"><img src="img/web6.png">
            </a>
        </div>
    </section>
    <!--Our videos-->
    ...
    <section class="footer">
        <div class="footer-box">
            ...
            <div class="social">
                <a href="https://www.facebook.com/people/Fond-Preneur/100085612765318/"><i
                        class='bx bxl-facebook'></i></a>
                <a href="https://twitter.com/fondpreneur?t=j5dSPznUibYDRhjKaeH4DA&s=09"><i
